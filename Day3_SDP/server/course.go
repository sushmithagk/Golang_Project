...
func readAllCourses(c *gin.Context) {
	courses := []Course{
		{Id: "1", Name: "Sushmi",
			Duration:    20,
			Trainername: "Nithin", Level: " Beginner", Description: "Python for Data Science",
			Price: 4000.00},
		{Id: "2", Name: "Sneha",
			Duration:    20,
			Trainername: "Mahesh", Level: " Intermediate", Description: " Java for Developers",
			Price: 5000.00},
	}
	fmt.Println(courses)
...
func readCourseById(c *gin.Context) {
	id := c.Param("id")
	course := Course{Id: id, Name: "Sneha",
		Duration:    20,
		Trainername: "Mahesh", Level: " Intermediate", Description: " Java for Developers",
		Price: 5000.00}
...
func createCourse(c *gin.Context) {
	...
	createdCouse := Course{Id: "10", Name: "Sushmitha",
		Duration:    20,
		Trainername: "Nithin", Level: " Beginner", Description: "Python for Data Science",
		Price: 4500.00}
...
func updateCourse(c *gin.Context) {
	...
	updatedCourse := Course{Id: id, Name: "Sushmi",
		Duration:    20,
		Trainername: "Nithin", Level: " Beginner", Description: "Python for Data Science",
		Price: 2000.00}
